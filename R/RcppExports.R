...
em <- function(param2, xvec, yvec, freq, n, expt, info, se, iter, maxiter, tol, showFlag, trajectory) {
    invisible(.Call('_bzinb_em', PACKAGE = 'bzinb', param2, xvec, yvec, freq, n, expt, info, se, iter, maxiter, tol, showFlag, trajectory))
}
